...
# add in info from active table, such as player info, etc
...
rm(games_release, games_tsibble)
gc()
...
We'll set our forecasting horizon as 7, 30, 90, 180, and 365 days into the future to start. Th

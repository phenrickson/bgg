...
background = plot_df %>%
        ...
        ggtitle(paste("Which games are similar to ", game, "?", sep= ""),
                subtitle = str_wrap("Placing games on first five principal components of variation, which generally correspond complexity, theme, economy, and coooperation.", 125))+
        theme(panel.grid.major = element_blank(),
              panel.grid.minor = element_blank())+

...
```{r assess by year, warning = F, message=F, error=F}
...
#                  file = here::here("predict_user_collections/data", 
#                                    paste(gsub("%20", "_", params$username), 
#                                          "_", params$end_training_year , ".Rdata", sep="")))
